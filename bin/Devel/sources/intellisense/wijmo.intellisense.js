...
wijmo.chart._BoxPlotter = function() {
/// <summary>Box plotter.</summary>
/// <returns type="wijmo.chart._BoxPlotter"></returns>
this._wjClassName = 'wijmo.chart._BoxPlotter';
_wjReownEvents(this);
}
wijmo.chart._BoxPlotter.prototype = new wijmo.chart._BarPlotter();
wijmo.chart._BoxPlotter._wjDict = _wjMerge(wijmo.chart._BarPlotter._wjDict, {});
wijmo.chart._BoxPlotter._wjClass = true;
...
/// <field name="wordWrap" type="Boolean">Gets or sets the word wrap setting of the row.</field>
...
/// <summary>Represents a Bollinger Bands&#174; overlay series for the @see:FinancialChart.
...
/// <summary>Initializes a new instance of a @see:ViewerBase control.</summary>
/// <param name="element" type="Object" optional="false">The DOM element that will host the control, or a selector for the host element (e.g. '#theCtrl').</param>
/// <param name="options" type="Object" optional="true">JavaScript object containing initialization data for the control.</param>
/// <returns type="wijmo.viewer.ViewerBase"></returns>
/// <field name="pageNumberChanged" type="wijmo.Event">Occurs after the page number is changed.</field>
/// <field name="viewModeChanged" type="wijmo.Event">Occurs after the view mode is changed.</field>
/// <field name="selectMouseModeChanged" type="wijmo.Event">Occurs after the select mouse mode is changed.</field>
/// <field name="fullScreenChanged" type="wijmo.Event">Occurs after the full page view mode is changed.</field>
/// <field name="zoomFactorChanged" type="wijmo.Event">Occurs after the zoom factor is changed.</field>
/// <field name="queryLoadingData" type="wijmo.Event">Queries the request data sent to the service before loading the document.</field>
/// <field name="serviceUrl" type="String">Gets or sets the service url.</field>
/// <field name="filePath" type="String">Gets or sets the document path.</field>
/// <field name="zoomFactor" type="Number">Gets or sets the zoom factor.</field>
/// <field name="viewMode" type="wijmo.viewer.ViewMode">Gets or sets the view mode.</field>
/// <field name="selectMouseMode" type="Boolean">Gets or sets a value indicating whether clicking and dragging with the mouse selects text.</field>
/// <field name="fullScreen" type="Boolean">Gets or sets whether viewer is under full screen mode.</field>
this._wjClassName = 'wijmo.viewer.ViewerBase';
this.pageNumberChanged = new wijmo.Event('wijmo.EventArgs');
...
/// <summary>Stretches page to show the whole page in viewer.</summary>
}
wijmo.viewer.ViewerBase.prototype.zoomToViewWidth = function() {
/// <summary>Stretches page to fit the width of viewer.</summary>
}
wijmo.viewer.ViewerBase.prototype.moveToPage = function(index) {
/// <summary>Moves to the page at the specified index.</summary>
/// <param name="index" type="Number" optional="false">Index (1-base) of the page to move to.</param>
/// <returns type="wijmo.viewer.IPromise">An @see:wijmo.viewer.IPromise object with current page number.</returns>
}
wijmo.viewer.ViewerBase.prototype.onPageNumberChanged = function(e) {
/// <summary>Raises the @see:pageNumberChanged event.</summary>
/// <param name="e" type="wijmo.EventArgs" optional="true">The event arguments.</param>
}
...
/// <summary>Raises the @see:selectMouseModeChanged event.</summary>
/// <param name="e" type="wijmo.EventArgs" optional="true">The event arguments.</param>
}
...
/// <param name="e" type="wijmo.viewer.QueryLoadingDataEventArgs" optional="false">@see:QueryLoadingDataEventArgs that contains the event data.</param>
}
...
wijmo.viewer.ViewerBase._wjDict = _wjMerge(wijmo.Control._wjDict, {pageNumberChanged:1,viewModeChanged:1,selectMouseModeChanged:1,fullScreenChanged:1,zoomFactorChanged:1,queryLoadingData:1,serviceUrl:2,filePath:2,zoomFactor:2,viewMode:2,selectMouseMode:2,fullScreen:2});
wijmo.viewer.ViewerBase._wjClass = true;
wijmo.viewer.ReportViewer = function(element, options) {
/// <summary>Initializes a new instance of a @see:ReportViewer control.</summary>
/// <param name="element" type="Object" optional="false">The DOM element that will host the control, or a selector for the host element (e.g. '#theCtrl').</param>
/// <param name="options" type="Object" optional="true">JavaScript object containing initialization data for the control.</param>
/// <returns type="wijmo.viewer.ReportViewer"></returns>
/// <field name="reportName" type="String">Gets or sets the report name.
/// 
/// Sets it with the report name defined in the FlexReport definition file. Please ignore it for SSRS report.</field>
/// <field name="paginated" type="Boolean">Gets or sets a value indicating whether the content should be represented as set of fixed sized pages.
/// 
/// The default value is null, means using the default value from document source.</field>
...
/// <param name="serviceUrl" type="String" optional="false">The root url of service.</param>
/// <param name="reportFilePath" type="String" optional="false">The report file path.</param>
/// <returns type="wijmo.viewer.IPromise">An @see:wijmo.viewer.IPromise object with a string array which contians the report names.</returns>
}
wijmo.viewer.ReportViewer.getReports = function(serviceUrl, path, data) {
/// <summary>Gets the catalog items in the specified folder path.</summary>
/// <param name="serviceUrl" type="String" optional="false">The root url of service.</param>
/// <param name="path" type="String" optional="false">The folder path.</param>
...
/// <summary>Initializes a new instance of a @see:PdfViewer control.</summary>
/// <param name="element" type="Object" optional="false">The DOM element that will host the control, or a selector for the host element (e.g. '#theCtrl').</param>
/// <param name="options" type="Object" optional="true">JavaScript object containing initialization data for the control.</param>
