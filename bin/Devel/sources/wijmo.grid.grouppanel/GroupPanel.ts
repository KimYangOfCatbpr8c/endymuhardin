...
module wijmo.grid.grouppanel {
    ...
    export class GroupPanel extends Control {
            ...
            if (this._gds) {
                ...
                for (var i = 0; i < this._gds.length; i++) {
                    ...
                    if (col) {
                        ...
                        var remove = createElement('<span wj-remove="" style="font-weight:normal;cursor:pointer;pointer;padding:12px;padding-right:3px">&times;</span>', mk);
        ...
        _groupsChanged(s: any, e: EventArgs) {
            this.invalidate();
        }
