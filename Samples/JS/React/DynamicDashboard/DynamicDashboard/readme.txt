...
Use mouse to drag tiles to new positions, or click the close button at the top-right 
...
The tile frame and the tile contents are defined as components, so you can easily
